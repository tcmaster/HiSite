...
public class MainActivity extends BaseActivity implements OnCheckedChangeListener {
	...
	private void initMainInterface() {
		rightView = LayoutInflater.from(this).inflate(R.layout.layout_main_right, null);
		leftView = LayoutInflater.from(this).inflate(R.layout.activity_org_forgotid, null);
		headView = LayoutInflater.from(this).inflate(R.layout.actionbar_main, null);
