...
public class UserCouponListAdapter extends BaseListAdapter<UserCouponModel> {
	...
	protected View getItemView(View convertView, int position) {
		...
		if (convertView == null) {
			...
			holder.iv_award_location = (ImageView) convertView.findViewById(R.id.iv_award_location);
			holder.iv_photo = (ImageView) convertView.findViewById(R.id.iv_photo);
			holder.iv_quickmark = (ImageView) convertView.findViewById(R.id.iv_quickmark);
			holder.tv_award_location = (TextView) convertView.findViewById(R.id.tv_award_location);
			holder.tv_com_name = (TextView) convertView.findViewById(R.id.tv_com_name);
			holder.tv_encode_no = (TextView) convertView.findViewById(R.id.tv_encode_no);
			holder.tv_money = (TextView) convertView.findViewById(R.id.tv_money);
			holder.tv_quickmark = (TextView) convertView.findViewById(R.id.tv_quickmark);
			holder.tv_time = (TextView) convertView.findViewById(R.id.tv_time);
			holder.tv_user_name = (TextView) convertView.findViewById(R.id.tv_user_name);
			holder.tv_valid = (TextView) convertView.findViewById(R.id.tv_valid);
			holder.ll_award_location = (LinearLayout) convertView.findViewById(R.id.ll_award_location);
			holder.ll_quickmark = (LinearLayout) convertView.findViewById(R.id.ll_quickmark);
			convertView.setTag(holder);
		} else
			holder = (ViewHolder) convertView.getTag();
		holder.ll_award_location.setOnClickListener(new OnClickListener() {
